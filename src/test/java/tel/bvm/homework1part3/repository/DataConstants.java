...
public class DataConstants {
    ...
    public static Student STUDENT_1 = new Student(1L, "Луна Лавгуд (Luna Lovegood)", 25, FACULTY_INFO(1));
    public static Student STUDENT_2 = new Student(2L, "Дин Томас (Dean Thomas)", 78, FACULTY_INFO(1));
    public static Student STUDENT_3 = new Student(3L, "Симус Финниган (Seamus Finnigan)", 43, FACULTY_INFO(3));
    public static Student STUDENT_4 = new Student(4L, "Блейз Забини (Blaise Zabini)", 67, FACULTY_INFO(2));
    public static Student STUDENT_5 = new Student(5L, "Миллисента Булстроуд (Millicent Bulstrode)", 89, FACULTY_INFO(4));
    public static Student STUDENT_6 = new Student(6L, "Панси Паркинсон (Pansy Parkinson)", 93, FACULTY_INFO(4));
    public static Student STUDENT_7 = new Student(7L, "Чо Чанг (Cho Chang)", 56, FACULTY_INFO(4));
    public static Student STUDENT_8 = new Student(8L, "Майкл Корнер (Michael Corner)", 34, FACULTY_INFO(1));
    public static Student STUDENT_9 = new Student(9L, "Роберт Хиллиард (Robert Hilliard)", 100, FACULTY_INFO(1));
    public static Student STUDENT_10 = new Student(10L, "Элеанор Брэнсток (Eleanor Branstock)", 18, FACULTY_INFO(1));
    public static Student STUDENT_11 = new Student(11L, "Кэти Белл (Katie Bell)", 73, FACULTY_INFO(3));
    public static Student STUDENT_12 = new Student(12L, "Алисия Спиннет (Alicia Spinnet)", 23, FACULTY_INFO(2));
    public static Student STUDENT_13 = new Student(13L, "Анджелина Джонсон (Angelina Johnson)", 64, FACULTY_INFO(4));
    public static Student STUDENT_14 = new Student(14L, "Кэтти Бел (Kathy Bell)", 83, FACULTY_INFO(2));
    public static Student STUDENT_15 = new Student(15L, "Колин Криви (Colin Creevey)", 49, FACULTY_INFO(2));
    public static Student STUDENT_16 = new Student(16L, "Гарри Поттер (Harry Potter)", 11, FACULTY_INFO(2));
    public static Student STUDENT_17 = new Student(17L, "Гермиона Грейнджер (Hermione Granger)", 11, FACULTY_INFO(2));
    public static Student STUDENT_18 = new Student(18L, "Рон Уизли (Ron Weasley)", 11, FACULTY_INFO(2));
    public static Student STUDENT_19 = new Student(19L, "Драко Малфой (Draco Malfoy)", 12, FACULTY_INFO(2));
    public static Student STUDENT_20 = new Student(20L, "Невилл Лонгботтом (Neville Longbottom)", 10, FACULTY_INFO(4));
    public static Student STUDENT_21 = new Student(21L, "Джинни Уизли (Ginny Weasley)", 7, FACULTY_INFO(3));
    public static Student STUDENT_22 = new Student(22L, "Альбус Дамблдор (Albus Dumbledore)", 115, FACULTY_INFO(2));
    public static Student STUDENT_23 = new Student(23L, "Северус Снегг (Severus Snape)", 38, FACULTY_INFO(3));
    public static Student STUDENT_24 = new Student(24L, "Филиус Флитвик (Filius Flitwick)", 75, FACULTY_INFO(1));

    public static Faculty FACULTY_INFO(long id) {
...
//    public static Faculty FACULTY_1_WITH_STUDENT_INFO = new Faculty(1, "Когневран (Ravenclaw)", "Красный (Red)", STUDENTS_FACULTY(FACULTY_1));
    ...
    public static List<Student> STUDENT_LIST_TEMPLATE(Faculty faculty) {
        List<Student> studentsFaculty = new ArrayList<>();
